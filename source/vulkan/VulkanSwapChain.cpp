...
namespace Vulgine {
    ...
    void VulkanSwapChain::initSurface(GLFWwindow *window) {
        ...
        {
            Utilities::ExitFatal(-1, "Could not find a graphics and/or presenting queue!");
        }

        // todo : Add support for separate graphics and presenting queue
        if (graphicsQueueNodeIndex != presentQueueNodeIndex)
        {
            Utilities::ExitFatal(-1,"Separate graphics and presenting queues are not supported yet!");
        }
